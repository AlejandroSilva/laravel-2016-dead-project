...
import SelectRange from '../../components/shared/SelectRange.jsx'
        ...
        return(
            <div>
                ...
                <a className="btn btn-success btn-xs pull-right"
                   href={`/auditorias/descargar-excel-por-rango?fechaInicial=${fechaInicial}&fechaFinal=${fechaFinal}&idCliente=${this.state.idCliente}`}
                >Exportar a Excel</a>
                ...
                <TablaAuditoriaSemanal
                    ...
                    {this.state.auditoriasFiltradas.length===0
                        ? <tr><td colSpan="16" style={{textAlign: 'center'}}><b>No hay auditorias para mostrar en este periodo.</b></td></tr>
