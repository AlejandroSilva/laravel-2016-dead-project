...
class RowAuditoriaSemanal extends React.Component{
    ...
    guardarInventario() {
        ...
        if(JSON.stringify(cambiosInventario)!=="{}"){
            ...
            this.props.guardarInventario(this.props.auditoria.idInventario, cambiosInventario)
        }else{
            console.log('inventario sin cambios, no se actualiza')
        }
    }
    guardarNominaDia() {
        this._guardarNomina(this.props.auditoria.nomina_dia.idNomina, {
    ...
    guardarNominaNoche(){
        this._guardarNomina(this.props.auditoria.nomina_noche.idNomina, {
                ...
                */}
                ...
                <td className={css.tdDotacionTotal}>
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.dotacionAsignadaTotal}
                        onGuardar={this.guardarInventario.bind(this)}
                    ...
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_dia.dotacionAsignada}
                    ...
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_noche.dotacionAsignada}
                ...
                <td className={css.tdLider}>
                    <Select style={{display: inventarioDia? 'block' : 'none'}}
                            ...
                            seleccionada={ this.props.auditoria.nomina_dia.idLider || ''}
                    ...
                    <Select style={{display: inventarioNoche? 'block' : 'none'}}
                            ...
                            seleccionada={ this.props.auditoria.nomina_noche.idLider || ''}
                ...
                <td className={css.tdLider}>
                    <Select style={{display: inventarioDia? 'block' : 'none'}}
                            ...
                            seleccionada={this.props.auditoria.nomina_dia.idCaptador1 || ''}
                            onSelect={this.guardarNominaDia.bind(this)}
                    ...
                    <Select style={{display: inventarioNoche? 'block' : 'none'}}
                            ...
                            seleccionada={this.props.auditoria.nomina_noche.idCaptador1 || ''}
                            onSelect={this.guardarNominaNoche.bind(this)}
                            opciones={opcionesCaptadores}
                            opcionNula={true}
                            opcionNulaSeleccionable={true}
                ...
                <td className={css.tdDotacion }>
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_dia.dotacionCaptador1}
                        onGuardar={this.guardarNominaDia.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
                    />
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_noche.dotacionCaptador1}
                        onGuardar={this.guardarNominaDia.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
                    />
                ...
                <td className={css.tdLider}>
                    <Select style={{display: inventarioDia? 'block' : 'none'}}
                            ...
                            seleccionada={this.props.auditoria.nomina_dia.idCaptador2 || ''}
                            onSelect={this.guardarNominaDia.bind(this)}
                            opciones={opcionesCaptadores}
                            opcionNula={true}
                            opcionNulaSeleccionable={true}
                    ...
                    <Select style={{display: inventarioNoche? 'block' : 'none'}}
                            ...
                            seleccionada={this.props.auditoria.nomina_noche.idCaptador2 || ''}
                            onSelect={this.guardarNominaNoche.bind(this)}
                            opciones={opcionesCaptadores}
                            opcionNula={true}
                            opcionNulaSeleccionable={true}
                ...
                <td className={css.tdDotacion}>
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_dia.dotacionCaptador2}
                        onGuardar={this.guardarNominaDia.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
                    />
                    ...
                    <InputDotacion
                        ...
                        asignada={this.props.auditoria.nomina_noche.dotacionCaptador2}
                        onGuardar={this.guardarNominaDia.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
                    />
                ...
                <td className={css.tdHora}>
                    <InputHora
                        ...
                        asignada={this.props.auditoria.nomina_dia.horaPresentacionLider}
                    ...
                    <InputHora
                        ...
                        asignada={this.props.auditoria.nomina_noche.horaPresentacionLider}
                ...
                */}
                ...
                <td className={css.tdHora}>
                    <InputHora
                        ...
                        asignada={this.props.auditoria.nomina_dia.horaPresentacionEquipo}
                        tooltipText={txtHrApertura}
                        onGuardar={this.guardarNominaDia.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
                    ...
                    <InputHora
                        ...
                        asignada={this.props.auditoria.nomina_noche.horaPresentacionEquipo}
                        tooltipText={txtHrCierre}
                        onGuardar={this.guardarNominaNoche.bind(this)}
                        focusRowAnterior={()=>{}}
                        focusRowSiguiente={()=>{}}
