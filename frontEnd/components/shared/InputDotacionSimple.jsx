...
// Estilos
import * as css from './InputDotacionSimple.css'

class InputDotacionSimple extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
            valor: '-',
...
InputDotacionSimple.defaultProps = {
    tooltipText: '..'
}
export default InputDotacionSimple