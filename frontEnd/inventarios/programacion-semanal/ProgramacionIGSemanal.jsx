...
import { CalendarContainer } from '../programacion-calendario/CalendarContainer.jsx'
        ...
        return(
            <div>
                ...
                <a className="btn btn-success btn-xs pull-right"
                    href={`/inventarios/descargar-excel-por-rango?fechaInicial=${fechaInicial}&fechaFinal=${fechaFinal}&cliente=${this.state.idCliente}`}>
                    Exportar a Excel
                </a>
