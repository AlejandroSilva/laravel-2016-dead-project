...
// Styles
import * as style from './AgregarInventario.css'
...
class AgregarInventario extends React.Component {
    ...
    onSeleccionarMes(evt){
        let mesSeleccionado = evt.target.value
        // buscar los locales
        this.props.buscarAuditorias(mesSeleccionado, this.state.idClienteSeleccionado)
        this.setState({
            mesSeleccionado: mesSeleccionado
        })
    }
    onSeleccionarCliente(event){
        ...
        // buscamos los locales de ese cliente
    ...
    agregarLocalesAlPegar(event){
        ...
        event.clipboardData.items[0].getAsString(texto=>{
            ...
            console.log('AgregarInventario.... resultado:', resultadoPegar)
        })
    }
            ...
            <div className="row">
                ...
                <div className="col-sm-2 form-group">
                    ...
                    <select className="form-control" name="fechaProgramada"
                            ...
                            onChange={this.onSeleccionarMes.bind(this)}>
