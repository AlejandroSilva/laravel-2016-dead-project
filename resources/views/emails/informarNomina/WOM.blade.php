...
<body>
    @if($nomina->rectificada==1)
        <p style="margin-bottom: 16px;">SEI Consultores, informa nómina RECTIFICADA por Administracor SEI, para el local <b>{{ $local->nombre }}</b>.</p>
    @else
        <p style="margin-bottom: 16px;">SEI Consultores, informa nómina de personal para el local <b>{{ $local->nombre }}</b> se encuentra disponible.</p>
    @endif
