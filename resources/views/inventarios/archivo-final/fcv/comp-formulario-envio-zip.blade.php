<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="/inventario/{{$inventario->idInventario}}/subir-zip-fcv" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-12">
                <input class="form-control" type="file" name="archivoFinalZip" {{ $puedeEditar? '' : 'disabled' }}>
            </div>

            <div class="col-sm-12">
                <input type="submit" class="btn btn-primary btn-sm btn-block" {{ $puedeEditar? '' : 'disabled' }}
                       name="submit">
            </div>
